"""
This scripts demonstrates how to use the 'argparse' library to parse command line arguments
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '-t','--temperature',   #how to give the argument in the command line, e.g.: -t 32 or --temperature 32
